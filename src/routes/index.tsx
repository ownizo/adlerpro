...
/* ───────── palette (landing only — fundo claro) ───────── */
const gold = '#C8961A'      // dourado da marca — botões, bordas, badges
const goldDeep = '#9A7416'  // dourado mais escuro para TEXTO sobre fundo claro (contraste)
const navy = '#0A1628'      // texto principal / títulos / acentos escuros
const navyMuted = '#5B6472' // texto secundário sobre fundo claro
const cream = '#FAF7F0'     // fundo base / secções quentes
const white = '#FFFFFF'     // bandas / cartões
const border = '#ECE6D8'    // hairline quente
const goldBand = '#F5ECD6'  // banda dourada pálida (CTA final)
  ...
  return (
    <div className="min-h-screen" style={{ background: cream, color: navy, overflowX: 'hidden' as const }}>
      ...
      <section style={{ background: cream, padding: '6rem 2.5rem 5rem', position: 'relative' as const, overflow: 'hidden' as const }}>
        {/* Decorative circles */}
        <div style={{ position: 'absolute' as const, top: '-200px', right: '-200px', width: '600px', height: '600px', borderRadius: '50%', border: '1px solid rgba(10,22,40,0.06)' }} />
        <div style={{ position: 'absolute' as const, bottom: '-150px', left: '-150px', width: '400px', height: '400px', borderRadius: '50%', border: '1px solid rgba(200,150,26,0.10)' }} />
        ...
        <div className="max-w-5xl mx-auto" style={{ position: 'relative' as const, zIndex: 1 }}>
          <div style={{ display: 'inline-block', background: gold, padding: '0.35rem 1rem', marginBottom: '1.5rem' }}>
            <span style={{ ...font(700, '0.7rem'), textTransform: 'uppercase' as const, letterSpacing: '0.12em', color: navy }}>
              {t('landing.heroBadge')}
            </span>
          </div>

          <h2 style={{ ...font(700, 'clamp(2.5rem, 5vw, 4.5rem)'), lineHeight: 1.05, letterSpacing: '-0.03em', color: navy, marginBottom: '1.5rem', maxWidth: '48rem' }}>
            {t('landing.heroTitle')} <span style={{ color: gold }}>{t('landing.heroTitleHighlight')}</span>
          </h2>

          <p
            style={{ ...font(300, '1.1rem'), lineHeight: 1.8, color: navyMuted, maxWidth: '36rem', marginBottom: '2.5rem' }}
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="#particulares" style={{ ...font(600, '0.9rem'), padding: '0.85rem 2rem', background: 'transparent', color: navy, border: `1.5px solid ${navy}`, borderRadius: '2px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
              {t('landing.heroCta2')}
            </a>
          </div>
        </div>
      ...
      {/* ══════════ TRUST BAR ══════════ */}
      <section style={{ borderTop: `1px solid ${border}`, borderBottom: `1.5px solid ${navy}`, background: white }}>
      ...
      {/* ══════════ PROBLEMA / SOLUÇÃO ══════════ */}
      <section style={{ padding: '5rem 2.5rem', background: cream }}>
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <h3 style={{ ...font(700, '1.75rem'), color: navy, marginTop: '0.75rem', marginBottom: '1.5rem', lineHeight: 1.2 }}>
            ...
            {/* Solução */}
            <div>
              <span style={{ ...font(700, '0.7rem'), textTransform: 'uppercase' as const, letterSpacing: '0.12em', color: goldDeep }}>
      ...
      {/* ══════════ FUNCIONALIDADES ══════════ */}
      <section id="funcionalidades" style={{ background: white, padding: '5rem 2.5rem', borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center" style={{ marginBottom: '3.5rem' }}>
            <span style={{ ...font(700, '0.7rem'), textTransform: 'uppercase' as const, letterSpacing: '0.12em', color: goldDeep }}>
              {t('landing.featuresBadge')}
            </span>
            <h2 style={{ ...font(700, '2.25rem'), color: navy, marginTop: '0.75rem', letterSpacing: '-0.02em' }}>
              {t('landing.featuresTitle')}
            </h2>
            <p style={{ ...font(300, '1rem'), color: navyMuted, marginTop: '1rem', maxWidth: '36rem', marginLeft: 'auto', marginRight: 'auto', lineHeight: 1.8 }}>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 style={{ ...font(700, '2.25rem'), color: navy, marginTop: '0.75rem', marginBottom: '1.5rem', letterSpacing: '-0.02em', lineHeight: 1.15 }}>
                {t('landing.iaTitle')}
              </h2>
              <p style={{ ...font(300, '1rem'), color: navyMuted, lineHeight: 1.8, marginBottom: '2rem' }}>
                {t('landing.iaDesc')}
              </p>
              <div className="space-y-4">
            ...
            <div style={{ background: white, borderRadius: '8px', padding: '2.5rem', border: `1px solid ${border}`, boxShadow: '0 8px 30px rgba(10,22,40,0.08)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.5rem' }}>
                <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#27AE60' }} />
                <span style={{ ...font(600, '0.75rem'), color: navyMuted, textTransform: 'uppercase' as const, letterSpacing: '0.1em' }}>{t('landing.iaPanelStatus')}</span>
              </div>
              <div className="space-y-4">
              ...
              <div style={{ marginTop: '1.5rem', padding: '1rem', background: cream, borderRadius: '4px', border: `1px solid ${border}` }}>
                <p style={{ ...font(600, '0.75rem'), color: goldDeep }}>{t('landing.iaTiming')}</p>
                <p style={{ ...font(700, '1.5rem'), color: navy }}>{'< 8 '}{t('landing.iaTimingUnit')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ══════════ VANTAGENS ══════════ */}
      <section id="vantagens" style={{ padding: '5rem 2.5rem', background: white, borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center" style={{ marginBottom: '3.5rem' }}>
            <span style={{ ...font(700, '0.7rem'), textTransform: 'uppercase' as const, letterSpacing: '0.12em', color: goldDeep }}>
      ...
      <section style={{ background: cream, padding: '5rem 2.5rem' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center" style={{ ...font(300, '0.9rem'), color: navyMuted, marginTop: '2rem' }}>
      ...
      {/* ══════════ PARTICULARES ══════════ */}
      <section id="particulares" style={{ background: white, padding: '5rem 2.5rem', borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center" style={{ marginBottom: '3rem' }}>
            <span style={{ ...font(700, '0.7rem'), textTransform: 'uppercase' as const, letterSpacing: '0.12em', color: goldDeep }}>
              {t('landing.particularesBadge')}
            </span>
            <h2 style={{ ...font(700, '2.25rem'), color: navy, marginTop: '0.75rem', marginBottom: '1.25rem', letterSpacing: '-0.02em' }}>
              {t('landing.particularesTitle')}
            </h2>
            <p style={{ ...font(300, '1.05rem'), color: navyMuted, lineHeight: 1.8, maxWidth: '40rem', marginLeft: 'auto', marginRight: 'auto' }}>
              {t('landing.particularesIntro')}
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <ParticularItem title={t('landing.partic1Title')} desc={t('landing.partic1Desc')} />
            <ParticularItem title={t('landing.partic2Title')} desc={t('landing.partic2Desc')} />
            <ParticularItem title={t('landing.partic3Title')} desc={t('landing.partic3Desc')} />
            <ParticularItem title={t('landing.partic4Title')} desc={t('landing.partic4Desc')} />
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '5rem 2.5rem', background: cream }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 style={{ ...font(700, '2.25rem'), color: navy, marginTop: '0.75rem', marginBottom: '1.5rem', letterSpacing: '-0.02em' }}>
            {t('landing.aboutTitle')}
          </h2>
          <p
            style={{ ...font(300, '1.05rem'), color: navyMuted, lineHeight: 1.8, marginBottom: '1rem', maxWidth: '40rem', marginLeft: 'auto', marginRight: 'auto' }}
            dangerouslySetInnerHTML={{ __html: t('landing.aboutP1') }}
          />
          <p
            style={{ ...font(300, '1.05rem'), color: navyMuted, lineHeight: 1.8, maxWidth: '40rem', marginLeft: 'auto', marginRight: 'auto' }}
      ...
      {/* ══════════ CTA FINAL ══════════ */}
      <section style={{ background: goldBand, padding: '5rem 2.5rem' }}>
        <div className="max-w-3xl mx-auto text-center">
          <img src="/logo.png" alt="Os Meus Seguros" style={{ height: '80px', width: 'auto', margin: '0 auto 2rem' }} />
          <h2 style={{ ...font(700, '2.5rem'), color: navy, marginBottom: '1rem', letterSpacing: '-0.02em' }}>
            {t('landing.ctaTitle')}
          </h2>
          <p style={{ ...font(300, '1.05rem'), color: navyMuted, lineHeight: 1.8, marginBottom: '2.5rem' }}>
            {t('landing.ctaDesc')}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" style={{ ...font(600, '0.9rem'), padding: '0.85rem 2.5rem', background: navy, color: '#fff', borderRadius: '2px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              {t('landing.ctaBtn')}
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </Link>
            <a href="mailto:insurance@adlerrochefort.com" style={{ ...font(600, '0.9rem'), padding: '0.85rem 2.5rem', background: 'transparent', color: navy, border: `1.5px solid ${navy}`, borderRadius: '2px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
      ...
      {/* ══════════ FOOTER ══════════ */}
      <footer style={{ padding: '2.5rem', borderTop: `1px solid ${border}`, background: cream }}>
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-6">
              <Link to="/contact" style={{ ...font(600, '0.78rem'), color: navyMuted, textDecoration: 'none' }}>{t('landing.footerContact')}</Link>
              <Link to="/terms-and-conditions" style={{ ...font(600, '0.78rem'), color: navyMuted, textDecoration: 'none' }}>{t('landing.footerTerms')}</Link>
              <Link to="/privacy-policy" style={{ ...font(600, '0.78rem'), color: navyMuted, textDecoration: 'none' }}>{t('landing.footerPrivacy')}</Link>
            </div>
            <div className="text-center md:text-right">
              <p style={{ ...font(400, '0.75rem'), color: navyMuted }}>
                {t('landing.footerCompany')}
              </p>
              <p style={{ ...font(400, '0.75rem'), color: navyMuted, marginTop: '0.25rem' }}>
                {t('landing.footerAsf')}
              </p>
            </div>
          </div>
...
function TrustMetric({ value, label, isLast }: { value: React.ReactNode; label: string; isLast?: boolean }) {
  return (
    <div style={{ padding: '1.75rem 1.5rem', borderRight: isLast ? 'none' : `1px solid ${border}` }}>
      <p style={{ ...font(700, '2rem'), color: navy }}>{value}</p>
      <p style={{ ...font(300, '0.78rem'), color: navyMuted }}>{label}</p>
    </div>
  )
}
...
function ProblemItem({ text }: { text: string }) {
  return (
    <div className="flex items-start gap-3">
      ...
      <span style={{ ...font(400, '0.9rem'), color: navyMuted }}>{text}</span>
    </div>
  )
}
...
function FeatureCard({ icon, title, desc, badge }: { icon: string; title: string; desc: string; badge?: string }) {
  return (
    <div style={{ background: cream, border: `1px solid ${border}`, borderRadius: '6px', padding: '2rem', boxShadow: '0 1px 3px rgba(10,22,40,0.05)', position: 'relative' as const }}>
      {badge && (
        <span style={{ position: 'absolute' as const, top: '1rem', right: '1rem', ...font(700, '0.65rem'), background: gold, color: navy, padding: '0.2rem 0.5rem', borderRadius: '2px', letterSpacing: '0.05em' }}>
          {badge}
        </span>
      )}
      <div style={{ width: '40px', height: '40px', background: white, border: `1px solid ${border}`, borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.25rem' }}>
        <svg className="w-5 h-5" style={{ color: navy }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d={icon} />
        </svg>
      </div>
      <h3 style={{ ...font(700, '1rem'), color: navy, marginBottom: '0.75rem' }}>{title}</h3>
      <p style={{ ...font(300, '0.875rem'), color: navyMuted, lineHeight: 1.7 }}>{desc}</p>
    </div>
  )
}
...
function IAFeature({ title, desc }: { title: string; desc: string }) {
  return (
    <div style={{ paddingLeft: '1rem', borderLeft: `2px solid ${gold}` }}>
      <p style={{ ...font(600, '0.9rem'), color: navy, marginBottom: '0.25rem' }}>{title}</p>
      <p style={{ ...font(300, '0.85rem'), color: navyMuted, lineHeight: 1.6 }}>{desc}</p>
    </div>
  )
}
...
function AIStep({ step, label, desc }: { step: string; label: string; desc: string }) {
  return (
    <div className="flex items-start gap-3">
      <span style={{ ...font(700, '0.7rem'), color: goldDeep, background: goldBand, padding: '0.25rem 0.5rem', borderRadius: '2px', flexShrink: 0 }}>{step}</span>
      <div>
        <p style={{ ...font(600, '0.8rem'), color: navy }}>{label}</p>
        <p style={{ ...font(300, '0.78rem'), color: navyMuted }}>{desc}</p>
      </div>
    </div>
  )
}
...
function ComparisonCard({ title, items, type }: { title: string; items: string[]; type: 'before' | 'after' }) {
  ...
  return (
    <div style={{
      background: isBefore ? cream : white,
      border: isBefore ? `1px solid ${border}` : `1.5px solid ${gold}`,
      borderRadius: '6px',
      padding: '2.5rem',
      boxShadow: isBefore ? 'none' : '0 8px 30px rgba(200,150,26,0.12)',
    }}>
      <h3 style={{ ...font(700, '1.25rem'), color: isBefore ? navyMuted : goldDeep, marginBottom: '1.5rem' }}>{title}</h3>
      <div className="space-y-3">
        {items.map((item, i) => (
          <div key={i} className="flex items-start gap-3">
            {isBefore ? (
              <svg className="w-4 h-4 flex-shrink-0" style={{ color: '#B8B09A', marginTop: '0.15rem' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
              </svg>
            ) : (
            ...
            <span style={{ ...font(400, '0.875rem'), color: isBefore ? navyMuted : navy, lineHeight: 1.5 }}>{item}</span>
          </div>
        ))}
      </div>
    </div>
...
function SectorCard({ icon, label }: { icon: string; label: string }) {
  return (
    <div className="text-center" style={{ padding: '1.5rem 1rem', background: white, border: `1px solid ${border}`, borderRadius: '6px', boxShadow: '0 1px 3px rgba(10,22,40,0.05)' }}>
      <div style={{ width: '40px', height: '40px', margin: '0 auto 0.75rem', background: cream, border: `1px solid ${border}`, borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <svg className="w-5 h-5" style={{ color: navy }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d={icon} />
        </svg>
      </div>
...
function ParticularItem({ title, desc }: { title: string; desc: string }) {
  return (
    <div style={{ background: cream, border: `1px solid ${border}`, borderRadius: '6px', padding: '1.5rem', boxShadow: '0 1px 3px rgba(10,22,40,0.05)' }}>
      <div style={{ width: '36px', height: '36px', background: white, border: `1px solid ${border}`, borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' }}>
        <svg className="w-5 h-5" style={{ color: gold }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
        </svg>
      </div>
      <h3 style={{ ...font(700, '0.95rem'), color: navy, marginBottom: '0.4rem' }}>{title}</h3>
      <p style={{ ...font(300, '0.85rem'), color: navyMuted, lineHeight: 1.6 }}>{desc}</p>
    </div>
  )
}
