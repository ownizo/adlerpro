...
const NAV_ITEMS = [
  ...
  { to: '/license-plates' as const, key: 'nav.fleetsAndPlates', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { to: '/partner-risk' as const, key: 'nav.partnersAndCredit', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  { to: '/documents' as const, key: 'nav.documents', icon: 'M9 12h6m-6 4h6m-3-8V4m5 16H7a2 2 0 01-2-2V6a2 2 0 012-2h5l5 5v9a2 2 0 01-2 2z' },
  { to: '/profile' as const, key: 'nav.profileCompany', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
]
          ...
          <div className="flex items-center gap-3">
            ...
            {ready && user && (
              <>
                ...
                <Link to="/weather-alerts" style={{ color: '#666666', display: 'flex', alignItems: 'center' }} title={t('nav.weatherAlerts')}>
