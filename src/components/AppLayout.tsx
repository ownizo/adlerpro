...
const NAV_ITEMS = [
  { to: '/dashboard' as const, label: 'Painel', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
...
const BOTTOM_NAV_ITEMS = [
  { to: '/dashboard' as const, label: 'Painel', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
  { to: '/policies' as const, label: 'Apólices', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { to: '/quotes-comparison' as const, label: 'Comparativo', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  { to: '/profile' as const, label: 'Perfil', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
]
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      >
        {/* Logo area — logo centrado, nome à esquerda */}
        ...
        {ready && user && (
          <div className="p-4 mt-auto" style={{ borderTop: '1px solid #eeeeee' }}>
            <div style={{ marginBottom: '0.5rem', padding: '0 0.25rem' }}>
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '0.75rem', fontWeight: 600, color: '#333333', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {user.name || user.email}
              </p>
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '0.65rem', color: '#999999', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {user.email}
              </p>
            </div>
            <button
              ...
              style={{ background: '#f8f8f8', color: '#666666', border: '1px solid #eeeeee', fontFamily: "'Montserrat', sans-serif" }}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header
          className="px-4 lg:px-8 h-14 flex items-center justify-between shrink-0"
            ...
            {ready && user && (
              <>
                <span
                  ...
                  style={{ color: '#666666', fontFamily: "'Montserrat', sans-serif", fontWeight: 300 }}
                >
                  {user.name || user.email}
                </span>
                <Link
      ...
      <nav
        ...
        style={{ background: '#ffffff', borderTop: '1.5px solid #111111', height: '60px' }}
      >
        {BOTTOM_NAV_ITEMS.map((item) => (
          ...
          >
            ...
            <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '0.6rem', fontWeight: 600, letterSpacing: '0.04em' }}>
              {item.label}
            </span>
          </Link>
        ))}
